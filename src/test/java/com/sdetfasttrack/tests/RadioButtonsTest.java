...
public class RadioButtonsTest {
    ...
    public void setRadioButtonPage(){
        ...
        assertTrue(radioButtonPage.redBtn.isSelected(), "Red button not selected");

        //8. Verify radio button #Blue is not selected.
        assertTrue(!radioButtonPage.blueBtn.isSelected(), "Blue button is selected");

        //9. Verify radio button #Green is Enabled
        assertTrue(!radioButtonPage.greenBtn.isEnabled(), "Green button is enable");
    }
